...
if output_type == "singleton"
    ...
    elseif type_reduction_method == "Classical_KM"
        ...
        for i=1:mbs
           [output_lower(:,:,i), output_upper(:,:,i)] = T2_KM(upper_firing_strength(:,:,i),lower_firing_strength(:,:,i),learnable_parameters.singleton.c,learnable_parameters.singleton.c,number_mf,number_outputs);
        end
