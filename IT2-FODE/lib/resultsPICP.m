function [meanPICP, stdPICP, arrayPICP] = resultsPICP(number_of_seed, number_of_rule, input_membership_type)

arrayPICP = zeros(3,number_of_seed);
...
meanPICP = mean(arrayPICP,2);
stdPICP = std(arrayPICP,0,2);
